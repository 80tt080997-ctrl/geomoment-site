...
.gm-i5__step { flex: 1 1 0; min-width: 0; background: #F5F5F7; border: 1px solid #E8E8EA; border-radius: 12px; padding: 16px 10px 14px; text-align: center; display: flex; flex-direction: column; gap: 6px; position: relative; }
...
.gm-i5__num { display: inline-block; width: 26px; height: 26px; line-height: 26px; margin: 0 auto; border-radius: 50%; font: 700 11px 'JetBrains Mono','Consolas',monospace; color: #FFFFFF; background: linear-gradient(135deg, #3D3DFF 0%, #5C5CFF 100%); }
.gm-i5__step--5 .gm-i5__num { background: linear-gradient(135deg, #7B5BFF 0%, #5A3DDB 100%); }
.gm-i5__icon { display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; margin: 4px auto 2px; border-radius: 10px; background: rgba(255,255,255,0.95); border: 1px solid rgba(123,91,255,0.18); color: #5A3DDB; }
...
.gm-i6__donut { --pct: 0; width: 64px; height: 64px; border-radius: 50%; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; flex: 0 0 auto; background: conic-gradient(#FFFFFF calc(var(--pct) * 1%), rgba(255,255,255,0.25) 0); }
.gm-i6__donut::before { content: ''; position: absolute; inset: 8px; border-radius: 50%; z-index: 0; }
...
.gm-i7__card { background: #FFFFFF; border: 1px solid #E8E8EA; border-radius: 14px; padding: 18px 14px 14px; display: flex; flex-direction: column; gap: 8px; transition: transform 0.2s, box-shadow 0.2s; position: relative; }
.gm-i7__card:hover { transform: translateY(-2px); box-shadow: 0 6px 18px rgba(11,11,15,0.08); }
.gm-i7__head { display: flex; align-items: center; justify-content: space-between; gap: 8px; }
.gm-i7__num { width: 30px; height: 30px; line-height: 30px; border-radius: 50%; text-align: center; font: 700 12px 'JetBrains Mono','Consolas',monospace; color: #FFFFFF; flex: 0 0 auto; }
.gm-i7__icon { display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; border-radius: 8px; background: #F5F5F7; flex: 0 0 auto; }
.gm-i7__icon svg { width: 18px; height: 18px; display: block; }
...
.gm-i8__donut { --pct: 0; --c: #E64A4A; width: 96px; height: 96px; border-radius: 50%; background: conic-gradient(var(--c) calc(var(--pct) * 1%), #E8E8EA 0); display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; flex: 0 0 auto; margin: 0 auto 14px; }
.gm-i8__donut::before { content: ''; position: absolute; inset: 11px; border-radius: 50%; background: #FFFFFF; z-index: 0; }
.gm-i8__donut > span, .gm-i8__donut > small { position: relative; z-index: 1; line-height: 1.05; }
.gm-i8__donut > span { font: 800 32px/1 'JetBrains Mono','Consolas',monospace; }
.gm-i8__panel--before .gm-i8__donut > span { color: #E64A4A; }
.gm-i8__panel--after .gm-i8__donut > span { color: #5A3DDB; }
.gm-i8__donut > small { font: 700 9px 'JetBrains Mono','Consolas',monospace; color: #5A5A66; margin-top: 3px; letter-spacing: 0.4px; }
...
.gm-i9__step-num { width: 32px; height: 32px; line-height: 32px; text-align: center; border-radius: 50%; font: 700 12px 'JetBrains Mono','Consolas',monospace; color: #FFFFFF; flex: 0 0 auto; }
  ...
  <div class="gm-i6__cols">
    <article class="gm-i6__col gm-i6__col--pass">
      <header class="gm-i6__head">
        <div class="gm-i6__donut" style="--pct:75"><span>75</span><small>AVG</small></div>
    ...
    <article class="gm-i6__col gm-i6__col--fail">
      <header class="gm-i6__head">
        <div class="gm-i6__donut" style="--pct:28"><span>28</span><small>AVG</small></div>
        <div class="gm-i6__head-text">
  ...
  <div class="gm-i7__grid">
    ...
    <article class="gm-i7__card">
      <div class="gm-i7__head">
        ...
        <span class="gm-i7__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 9V5a3 3 0 0 0-6 0v4M5 9h14l-1 12H6L5 9z"/></svg></span>
      </div>
...
<figure class="gm-infographic gm-i8">
  ...
  <div class="gm-i8__cols">
    <article class="gm-i8__panel gm-i8__panel--before">
      ...
      <div class="gm-i8__donut" style="--pct:35;--c:#E64A4A"><span>35</span><small>AVG SCORE</small></div>
    ...
    <article class="gm-i8__panel gm-i8__panel--after">
      ...
      <div class="gm-i8__donut" style="--pct:72;--c:#7B5BFF"><span>72</span><small>AVG SCORE</small></div>
