...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "FAQPage",
      "@id": "https://geomoment.me/blog/geo-introduction/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "GEO가 도대체 뭔가요?",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "직접 측정해보는 것이 가장 빠릅니다. ChatGPT에 자사 카테고리 추천을 물어 답변에 회사가 등장하는지 확인합니다. 등장하지 않으면 GEO가 필요한 신호이며 GeoMoment 무료 진단으로 ChatGPT·Perplexity·Gemini·Claude 네 개 AI에 동시 측정해 EEAT·토픽 권위도·엔티티 현저성·청크 적합도 4축으로 약점을 진단받을 수 있습니다."
          }
        }
      ]
    },
    {
      "@type": "HowTo",
      "@id": "https://geomoment.me/blog/geo-introduction/#howto",
    ...
    {
      "@type": "BlogPosting",
      "@id": "https://geomoment.me/blog/geo-introduction/#article",
      ...
      "inLanguage": "ko",
      "image": "https://geomoment.me/assets/img/blog/geo-introduction/og.png",
      "mainEntityOfPage": "https://geomoment.me/blog/geo-introduction/",
      "about": [
      ...
      "mentions": [
        {"@type": "SoftwareApplication", "name": "ChatGPT", "sameAs": "https://chatgpt.com/"},
        {"@type": "SoftwareApplication", "name": "Gemini", "sameAs": "https://gemini.google.com/"},
        {"@type": "SoftwareApplication", "name": "Claude", "sameAs": "https://claude.ai/"},
        {"@type": "SoftwareApplication", "name": "Perplexity", "sameAs": "https://www.perplexity.ai/"},
